...
hl.bind("SUPER + ALT + left", hl.dsp.window.resize({ x = -32, y = 0, relative = true }))
hl.bind("SUPER + ALT + right", hl.dsp.window.resize({ x = 32, y = 0, relative = true }))
hl.bind("SUPER + ALT + up", hl.dsp.window.resize({ x = 0, y = -32, relative = true }))
hl.bind("SUPER + ALT + down", hl.dsp.window.resize({ x = 0, y = 32, relative = true }))
